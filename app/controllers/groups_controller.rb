class GroupsController < GroupBaseController
  ...
  def export
    ...
    @proposal_fields = %w[id group_id discussion_id author_id discussion_title author_name proposal_title description created_at closed_at outcome commited_votes_count yes_votes_count no_votes_count abstain_votes_count block_votes_count confused_votes_count closing_at did_not_votes_count votes_count]
